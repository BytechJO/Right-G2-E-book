...
const Reading_Unit10_Page2 = () => {
  ...
  const clickableAreas = [
    { id: "p10-1",x1: 9.0, y1: 39.0, x2: 45.8, y2: 48.34, sound: sound1 },
    { id: "p10-2",x1: 49.0, y1: 39.2, x2: 85.4, y2: 48.34, sound: sound2 },
    { id: "p10-3",x1: 9.0, y1: 84.5, x2: 45.0, y2: 93.58, sound: sound3 },
    { id: "p10-4",x1: 49.0, y1: 84.5, x2: 86.5, y2: 93.42, sound: sound4 },
  ];
