...
const Reading_Unit6_Page2 = () => {
  ...
  const clickableAreas = [
    { id: "p6-1", x1: 9.0, y1: 39.0, x2: 45.8, y2: 45.9, sound: sound1 },
    { id: "p6-2", x1: 49.0, y1: 39.2, x2: 85.4, y2: 45.9, sound: sound2 },
    { id: "p6-3", x1: 9.0, y1: 86, x2: 45.0, y2: 92.2, sound: sound3 },
    { id: "p6-4", x1: 49.0, y1: 86, x2: 86.5, y2: 92.2, sound: sound4 },
  ];
